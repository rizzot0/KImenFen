...
public class AdministradorController {
    ...
    public String asociarAlumnoApoderado(@RequestParam("alumnoId") String alumnoId,
        ...
        Alumno alumno = alumnoRepository.findById(alumnoId).orElseThrow(() -> new IllegalArgumentException("Alumno no encontrado: " + alumnoId));
        Apoderado apoderado = apoderadoRepository.findById(apoderadoId).orElseThrow(() -> new IllegalArgumentException("Apoderado no encontrado: " + apoderadoId));
